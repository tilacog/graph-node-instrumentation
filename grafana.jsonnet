...
local stopwatch_sections = [
  'host_export_store_set__proof_of_indexing',
  'host_export_store_set__insert_id',
  'host_export_store_set__validation',
  'host_export_store_set__post_validation',
  'host_export_store_set__wasm_instance_context_store_set',
  ...
  panels: [
    {
      ...
      targets: [
        ...
        // jsonnet begins here
        {
          expr: std.format(template, stopwatch_sections[idx - 1]),
          instant: true,
          interval: '',
          legendFormat: stopwatch_sections[idx - 1],
          refId: 'Q' + idx,
        }
        for idx in std.range(1, std.length(stopwatch_sections))
      ],
